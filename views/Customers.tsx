...
const Customers: React.FC<CustomersProps> = ({ customers, invoices, setInvoices }) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Sales, ordering, and accounts receivable</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <h3 className="font-bold mb-4">Top Accounts</h3>
          ...
          <div className="bg-amber-50 rounded-xl border border-amber-200 p-6">
            ...
            <p className="text-xs text-amber-700">3 invoices are currently over 30 days past due. Action required for Mining Corp Katanga.</p>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl animate-in fade-in slide-in-from-bottom-4">
            <div className="px-8 py-6 border-b flex justify-between items-center">
              <h3 className="text-xl font-bold">New Customer Order</h3>
            ...
            <div className="p-8 grid grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1">Fuel Selection</label>
                <select className="w-full bg-slate-50 border rounded-lg px-4 py-2">
